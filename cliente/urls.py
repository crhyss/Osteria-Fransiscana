...
from .views import salir, registro, carrito, pedido,addcart, mesero, reclamos, addDirec, listarReclamos, perfilCliente, modificarPerfil, reserva, entrar, cambiarContraseña, historialReservas,orders,deletecart,menu
